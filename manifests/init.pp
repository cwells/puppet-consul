...
class consul (
  ...
  String $arch                               = $consul::params::arch,
  String $archive_path                       = $consul::params::archive_path,
  String $bin_dir                            = $consul::params::bin_dir,
  Integer $binary_group                      = $consul::params::binary_group,
  String $binary_mode                        = $consul::params::binary_mode,
  String $binary_name                        = $consul::params::binary_name,
  String $binary_owner                       = $consul::params::binary_owner,
  ...
  String $config_mode                        = $consul::params::config_mode,
  String $docker_image                       = $consul::params::docker_image,
  String $download_extension                 = $consul::params::download_extension,
  Optional[Stdlib::HTTPUrl] $download_url    = undef,
  String $download_url_base                  = $consul::params::download_url_base,
  Array $extra_groups                        = $consul::params::extra_groups,
  String $extra_options                      = $consul::params::extra_options,
  String $group                              = $consul::params::group,
  String $log_file                           = $consul::params::log_file,
  String $init_style                         = $consul::params::init_style,
  String $install_method                     = $consul::params::install_method,
  Boolean $join_wan                          = $consul::params::join_wan,
  ...
  String $os                                 = $consul::params::os,
  String $package_ensure                     = $consul::params::package_ensure,
  String $package_name                       = $consul::params::package_name,
